...
$(document).ready(function () {
    ...
    $("#systemAdminLoginBtn").click(function (e) {
        authRequest();
    });
...
function authRequest() {
    ...
    $.ajax({
        url: BASE_URL + '/airline/authenticate',
        type: "POST",
        headers: {
...
function saveUpdateUserToken(userName) {
    ...
    $.ajax({
        url: BASE_URL + '/airline/userAccount/saveUpdateToken/' + userName,
        type: "POST",
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function pageRedirection(token) {
    ...
    $.ajax({
        url: BASE_URL + '/airline/userAccount/home',
        type: "GET",
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        ...
        success: function (data) {
            ...
            window.location.href = BASE_URL + "/airline" + "/" + homePage + "/" + token;
        }
    });
}
